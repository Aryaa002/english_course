...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($judul) || empty($deskripsi)) {
        ...
        $stmt = $pdo->prepare("INSERT INTO toefl_tests (judul, deskripsi, waktu, passing_grade, is_active) VALUES (?, ?, ?, ?, ?)");
        if ($stmt->execute([$judul, $deskripsi, $waktu, $passing_grade, $is_active])) {
            $toefl_id = $pdo->lastInsertId();
            $success = 'TOEFL berhasil ditambahkan! <a href="toefl_sections.php?toefl_id=' . $toefl_id . '">Tambahkan sections sekarang</a>';
            echo '<meta http-equiv="refresh" content="3;url=toefl.php">';
        } else {
            $error = 'Gagal menambahkan TOEFL!';
        }
    }
}
?>
...
<head>
    ...
    <title>Tambah TOEFL - English Course</title>
            ...
            <div class="top-bar">
                <div class="page-title">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4><i class="fas fa-plus-circle" style="color: #F4B41A;"></i> Tambah TOEFL</h4>
                            <p>Tambah test TOEFL baru</p>
                        </div>
                    </div>
                </div>
                <div class="user-info">
                ...
                <form method="POST" action="">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="judul" name="judul" placeholder="Contoh: TOEFL Practice Test 1" required>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control" id="waktu" name="waktu" value="120" min="30" max="240">
                        </div>
                        
                        <div class="col-md-4 mb-3">
                            <label for="passing_grade">Passing Grade</label>
                            <input type="number" class="form-control" id="passing_grade" name="passing_grade" value="500" min="0" max="677">
                        </div>
                        ...
                        <div class="col-md-12">
                            <button type="submit" class="btn-submit">
                                <i class="fas fa-save me-2"></i>Simpan TOEFL
                            </button>
                        </div>
                    </div>
                </form>
